...
<body class="sidebar-light">
    @include('dashboard.pengaturan.content')
    ...
    <script>
        ...
        const plusIcon = document.querySelector('.ti-angle-right');
        const minusIcon = document.querySelector('.ti-angle-down');
    ...
    <script>
        function checkPasswordMatch() {
            ...
            // Check if the passwords match and meet the complexity requirements
            if (newPassword === reNewPassword && isPasswordComplex(newPassword)) {
                submitButton.disabled = false;
                submitButton.classList.remove("bg-secondary");
                submitButton.classList.add("bg-gradient-success");
            } else {
                submitButton.disabled = true;
                submitButton.classList.remove("bg-gradient-success");
        ...
        function isPasswordComplex(password) {
            ...
            // contains at least 1 uppercase letter, 1 lowercase letter, and 1 number
